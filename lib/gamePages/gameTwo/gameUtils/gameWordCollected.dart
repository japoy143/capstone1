...
class WordCollected2 extends StatelessWidget {
  WordCollected2({Key, key, required this.allwords, required this.allscore})
      : super(key: key);
      ...
      content: Container(
        ...
        child: Column(children: <Widget>[
          Text(
            'Words Collected',
            style: TextStyle(
                fontSize: 24, fontFamily: 'Anton', color: Colors.amber[500]),
          ),
          SizedBox(
            height: 10.0,
          ),
