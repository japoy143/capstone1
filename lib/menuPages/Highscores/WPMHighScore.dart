...
class WPMhighScore extends StatefulWidget {
  WPMhighScore({super.key});

  @override
  State<WPMhighScore> createState() => _WPMhighScoreState();
}

class _WPMhighScoreState extends State<WPMhighScore> {
  ...
  void sort() {
    sortedScores = userScore.values.toList()
      ..sort((a, b) => b.wordPerMinute.compareTo(a.wordPerMinute));
  }
